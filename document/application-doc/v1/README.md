# Application Documentation v1

This folder is the source of truth for the original application baseline.
...
Do not use v2 modular requirements to extend or reinterpret a v1 task.
