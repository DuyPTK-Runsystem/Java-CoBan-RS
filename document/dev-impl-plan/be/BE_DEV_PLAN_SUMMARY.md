...
|   033 | [Class Attendance Summary](attendance/033-class-attendance-summary-2026-08-24.md)                                                | API read-only tổng hợp chuyên cần theo lớp, thời gian và từng học sinh cho GVCN                                                  | Draft - awaiting user approval | 2026-08-24 |
