...
|   042 | [Subject Calculation Engine & Worker Lifecycle](scorebook/042-subject-calculation-engine-and-worker-lifecycle-2026-08-25.md)        | Pure calculation engine (Đtbmh, skill_score, Đtbhk, ĐtbmhCN, Đtbcn), worker lifecycle, claim, retry, version protection, API            | Draft    | 2026-08-25 |
