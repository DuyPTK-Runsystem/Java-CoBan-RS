...
### B.2 Timetable entries — full 16-class fixture implemented; scenarios còn lại chưa seed

Seeder hiện tạo đủ 16 lớp `6A1`–`9A4` ở `HK1` và `HK2`, trong khoảng
`2026-09-01`–`2026-12-31` và `2027-01-01`–`2027-05-31`, với revision `DRAFT`,
376/388 tiết môn học, audit marker `SEED_PLAN_081_FULL_V2`, phòng Tin/Nghề theo
mapping và kiểm tra conflict. Các scenario workflow bên dưới vẫn là dữ liệu minh
họa, không phải rows sẽ tạo bởi seeder.
...
| `TTE-081-06` | `7A1` | `TIN_HOC`   | `GV006` | WED | `AFTERNOON` |      1 | `TIN-1`       | valid                      |
