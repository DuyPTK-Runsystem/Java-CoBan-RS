...
export const placementReviewFixture: PlacementSession = {
  ...
  targetClasses: [
    { classId: 81, classCode: '8A1', className: 'Lớp 8A1', profile: 'REGULAR', capacity: 35, genderTargetMale: 17, genderTargetFemale: 18, currentStudentCount: 28 },
    { classId: 82, classCode: '8A2', className: 'Lớp 8A2', profile: 'ADVANCED', capacity: 30, genderTargetMale: 15, genderTargetFemale: 15, currentStudentCount: 24 },
  ],
  results: [
