...
import CalculationTaskDetailModal from '@/components/calculation/CalculationTaskDetailModal.vue'
import CalculationTaskTable from '@/components/calculation/CalculationTaskTable.vue'
import RetryConfirmationModal from '@/components/calculation/RetryConfirmationModal.vue'
import ScoreAuditLogTable from '@/components/scorebook/ScoreAuditLogTable.vue'
...
import { fetchCalculationTasks, fetchFailedCalculationTasks } from '@/services/calculationTaskApi'
import { useCalculationRetry } from '@/composables/useCalculationRetry'
...
const {
  selectedDetailTask, isDetailModalVisible, isRetryModalVisible, retryMode,
  targetRetryTask, retryingTaskId, retrying,
  openDetail: handleOpenDetail, openSingleRetry: handleOpenSingleRetry,
  openBulkRetry: handleOpenBulkRetry, confirmRetry: handleConfirmRetry,
} = useCalculationRetry({
  token, conflictMessage, errorMessage, successMessage,
  reloadTasks: loadTasks,
  reloadTranscriptStatus: loadTranscriptStatus,
...
<style scoped src="@/styles/calculation-operations.css"></style>
