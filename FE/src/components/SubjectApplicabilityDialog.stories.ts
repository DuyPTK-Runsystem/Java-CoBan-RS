...
import type { GradeLevel, Semester, Subject, SubjectApplicability } from '@/types/academic'
...
export const ExistingConfigurations: Story = { args: { applicabilities } }
export const EditingExistingConfiguration: Story = { args: { mode: 'edit', initialValue: applicabilities[0], applicabilities } }
