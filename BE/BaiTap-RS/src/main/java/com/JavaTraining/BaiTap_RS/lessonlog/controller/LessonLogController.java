...
public class LessonLogController {
    ...
    @GetMapping("/my-schedule") @PreAuthorize(TEACHER_ROLE) @ApiMessage("Lấy lịch dạy cá nhân")
    ...
    @GetMapping("/policy") @PreAuthorize(ADMIN_ACADEMIC_ROLE) @ApiMessage("Lấy policy sổ đầu bài")
    ...
    @GetMapping("/classes") @PreAuthorize(ADMIN_ACADEMIC_TEACHER_ROLE) @ApiMessage("Lấy lớp có sổ đầu bài")
    public List<LessonLogClassResponse> classes(@RequestParam Long semesterId){return service.classes(semesterId);}
    @GetMapping("/class/{classId}") @PreAuthorize(ADMIN_ACADEMIC_TEACHER_ROLE) @ApiMessage("Lấy sổ đầu bài theo tuần")
    ...
    @GetMapping("/class/{classId}/weekly-review/revisions") @PreAuthorize(ADMIN_ACADEMIC_TEACHER_ROLE) @ApiMessage("Lấy lịch sử ký tuần")
    ...
    @GetMapping("/policy/revisions") @PreAuthorize(ADMIN_ACADEMIC_ROLE) @ApiMessage("Lấy lịch sử policy")
    ...
    @PutMapping("/policy") @PreAuthorize(ADMIN_ACADEMIC_ROLE) @ApiMessage("Cập nhật policy sổ đầu bài")
    public LessonLogPolicyResponse putPolicy(@Valid @RequestBody ReqPolicyDTO request){return service.putPolicy(request);}
    @PostMapping("/class/{classId}/weekly-review") @PreAuthorize(ADMIN_ACADEMIC_TEACHER_ROLE) @ApiMessage("Ký sổ đầu bài theo tuần")
