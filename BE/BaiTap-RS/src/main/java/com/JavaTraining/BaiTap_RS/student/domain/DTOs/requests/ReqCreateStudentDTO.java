...
public class ReqCreateStudentDTO {
    ...
    public ReqCreateStudentDTO(
            String studentCode, String studentName, LocalDate dateOfBirth, String address, Double averageScore) {
        this(studentCode, studentName, dateOfBirth, address, averageScore, null);
    }
}
